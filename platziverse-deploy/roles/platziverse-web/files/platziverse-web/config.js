...
module.exports = {
  endpoint: process.env.API_ENDPOINT || 'http://138.197.215.53',
  serverHost: process.env.SERVER_HOST || 'http://167.172.215.249',
  mqttHost: process.env.MQTT_HOST || 'mqtt://138.197.215.53',
